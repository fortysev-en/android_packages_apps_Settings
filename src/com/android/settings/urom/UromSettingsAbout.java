...
public class UromSettingsAbout extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDevs0Url = findPreference("urom_devs_field0");
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mSourceUrl) {
            launchUrl("https://github.com/hitman-xda");
        } else if (preference == mXdaUrl) {
            launchUrl("http://forum.xda-developers.com/xperia-s/acro-s-development/rom-naosp-rom-acro-s-t3507721");
            ...
            launchUrl("http://forum.xda-developers.com/donatetome.php?u=6406816");
        } else if (preference == mDevs0Url) {
            launchUrl("http://forum.xda-developers.com/member.php?u=6406816");
